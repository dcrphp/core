...
SQL;
    ...
    public function install(
        ...
        try {
            ...
            //开始建表
            $schemaTool = new \Doctrine\ORM\Tools\SchemaTool(container('em'));
            $classes = container('em')->getMetadataFactory()->getAllMetadata();
