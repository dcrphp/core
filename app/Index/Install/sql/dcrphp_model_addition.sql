...
CREATE TABLE `model_addition` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `udx_ml_id` (`ma_ml_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='模型附加表：ma开头是为了模型实别字段';
