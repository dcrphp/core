...
class ConfigListItem
{
     ...
     * @var string
     *
     * @ORM\Column(name="form_text", type="string", length=45, nullable=false, options={"default"=""})
     */
    private $formText = '';
     ...
     * @var string
     *
     * @ORM\Column(name="data_type", type="string", length=10, nullable=false, options={"default"=""})
     */
    private $dataType = '';
     ...
     * @var string
     *
     * @ORM\Column(name="default_str", type="string", length=45, nullable=false, options={"default"=""})
     */
    private $defaultStr = '';
