...
class Config
{
     ...
     * @var string
     *
     * @ORM\Column(name="db_field_name", type="string", length=45, nullable=false, options={"default"="","comment"="字段名"})
     */
    private $dbFieldName = '';
     ...
     * @var string
     *
     * @ORM\Column(name="value", type="string", length=45, nullable=false, options={"default"="","comment"="字段值"})
     */
    private $value = '';
