...
class ConfigList
{
     ...
     * @var string
     *
     * @ORM\Column(name="type", type="string", length=45, nullable=false, options={"comment"="类型 配置还是模型(config or model)"})
     */
    private $type = '';
     ...
     * @var string
     *
     * @ORM\Column(name="keyword", type="string", length=45, nullable=false, options={"comment"="关键字，可以用来给列表做区别"})
     */
    private $keyword = '';
